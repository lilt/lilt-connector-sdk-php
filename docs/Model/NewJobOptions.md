...
**lilt_domain_id** | **int** | An integer value specifying the related domain. | [optional]
...
**metadata** | **object** | Metadata properties. | [optional]
**domain_id** | **int** | The user selected domain ID. | [optional]
**target_models** | [**\LiltConnectorSDK\Model\NewJobOptionsTargetModelsInner[]**](NewJobOptionsTargetModelsInner.md) | The list of target models to use for the new job. The values provided will override the default target models. | [optional]
