...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://connectors-admin.lilt.com/api/v1.0';
    ...
    {
        $report  = 'PHP SDK (LiltConnectorSDK) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://connectors-admin.lilt.com/api/v1.0",
