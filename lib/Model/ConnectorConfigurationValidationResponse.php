...
/**
 * ConnectorConfigurationValidationResponse Class Doc Comment
 *
 * @category Class
 * @package  LiltConnectorSDK
 * @author   OpenAPI Generator team
 ...
 */
class ConnectorConfigurationValidationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Connector_Configuration_Validation_Response';
    ...
    */
     ...
     * Sets message
     *
     * @param string|null $message Message for the validation response
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name name of the step that was validated
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Result of the Validation
     *
     * @return self
     */
