...
class SettingsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'target_memories' => 'array<string,\LiltConnectorSDK\Model\SettingsResponseTargetMemoriesValue>',
    ...
    protected static $setters = [
        ...
        'target_memories' => 'setTargetMemories',
    ...
    protected static $getters = [
        ...
        'target_memories' => 'getTargetMemories',
    ...
    public const LILT_TRANSLATION_WORKFLOW_UNKNOWN = 'UNKNOWN';
    ...
    public function getLiltTranslationWorkflowAllowableValues()
    {
        return [
            ...
            self::LILT_TRANSLATION_WORKFLOW_UNKNOWN,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('target_memories', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets target_memories
     *
     * @return array<string,\LiltConnectorSDK\Model\SettingsResponseTargetMemoriesValue>|null
     */
    public function getTargetMemories()
    {
        return $this->container['target_memories'];
    }

    /**
     * Sets target_memories
     *
     * @param array<string,\LiltConnectorSDK\Model\SettingsResponseTargetMemoriesValue>|null $target_memories target_memories
     *
     * @return self
     */
    public function setTargetMemories($target_memories)
    {
        if (is_null($target_memories)) {
            throw new \InvalidArgumentException('non-nullable target_memories cannot be null');
        }
        $this->container['target_memories'] = $target_memories;
     ...
     *
     * @param string|null $lilt_translation_workflow This indicates the translation workflow being used. UNKNOWN will only be displayed in exceptional cases.
     *
     * @return self
     */
