...
class NewJobOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'metadata' => 'object',
        'domain_id' => 'int',
        'target_models' => '\LiltConnectorSDK\Model\NewJobOptionsTargetModelsInner[]'
    ];
    ...
    protected static $setters = [
        ...
        'lilt_domain_id' => 'setLiltDomainId',
    ...
    protected static $getters = [
        ...
        'lilt_domain_id' => 'getLiltDomainId',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('lilt_domain_id', $data ?? [], null);
        ...
        $this->setIfExists('target_models', $data ?? [], null);
    }
    ...
    */
     ...
     * @return int|null
     */
    public function getLiltDomainId()
    {
        return $this->container['lilt_domain_id'];
    }

    /**
     * Sets lilt_domain_id
     *
     * @param int|null $lilt_domain_id An integer value specifying the related domain.
     *
     * @return self
     */
    public function setLiltDomainId($lilt_domain_id)
    {
        if (is_null($lilt_domain_id)) {
            throw new \InvalidArgumentException('non-nullable lilt_domain_id cannot be null');
        }
        $this->container['lilt_domain_id'] = $lilt_domain_id;
     ...
     * Sets metadata
     *
     * @param object|null $metadata Metadata properties.
     *
     * @return self
     */
     ...
     * Sets domain_id
     *
     * @param int|null $domain_id The user selected domain ID.
     *
     * @return self
     */
     ...
     * Gets target_models
     *
     * @return \LiltConnectorSDK\Model\NewJobOptionsTargetModelsInner[]|null
     */
    public function getTargetModels()
    {
        return $this->container['target_models'];
    }

    /**
     * Sets target_models
     *
     * @param \LiltConnectorSDK\Model\NewJobOptionsTargetModelsInner[]|null $target_models The list of target models to use for the new job. The values provided will override the default target models.
     *
     * @return self
     */
    public function setTargetModels($target_models)
    {
        if (is_null($target_models)) {
            throw new \InvalidArgumentException('non-nullable target_models cannot be null');
        }
        $this->container['target_models'] = $target_models;
